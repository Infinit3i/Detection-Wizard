...
pub static TTP_CATALOG: &[TtpDef] = &[
    ...
    t("T1036.005", "Match Legitimate Name or Location", "Defense Evasion"),
    t("T1055.002", "Portable Executable Injection", "Defense Evasion"),
    ...
    t("T1564.001", "Hidden Files and Directories", "Defense Evasion"),
    ...
    t("T1048.003", "Exfil Over Unencrypted Non-C2 Protocol", "Exfiltration"),
